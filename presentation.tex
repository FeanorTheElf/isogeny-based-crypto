...
\begin{frame}
    ...
    \begin{itemize}
        ...
        but in $K(E)$ have
        \begin{equation*}
            \frac {(y - 1)(x + 1)} {x(x + 1)} = \frac {y - 1} {x} \ \Rightarrow \ f(-1, -1) = \frac {-1 - 1} {-1} = 2
        \end{equation*}
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \end{align*}
    \pause
    So $\phi = [\lambda_1 x + \lambda_2 y + \lambda_3, \ \mu_1 x + \mu_2 y + \mu_3]$
    \pause
    \begin{align*}
...
\begin{frame}
    ...
    \begin{center}
        \uncover<2->{
            \only<1-2>{\includegraphics{scheme2_0.pdf}}
            \only<3>{\includegraphics{scheme2_1.pdf}}
            \only<4>{\includegraphics{scheme2_2.pdf}}
            \only<5>{\includegraphics{scheme2_3.pdf}}
            \only<6>{\includegraphics{scheme2_4.pdf}}
            \only<7>{\includegraphics{scheme2_5.pdf}}
...
\begin{frame}
    ...
    \begin{center}
        \includegraphics{scheme2_6.pdf}
    \end{center}
    \begin{equation*}
        \text{Claim:} \ E / \langle A, B \rangle \cong E / \langle B \rangle / \langle A' \rangle
    \end{equation*}
    \begin{align*}
        &A' := \beta(A) = [m_A]\beta(P_A) + [n_A]\beta(Q_A), \quad 
        \uncover<2->{
            \alpha': E/\langle B \rangle \to E/\langle B \rangle / \langle A' \rangle & \\
        }
        \uncover<3->{
            \Rightarrow \ & \beta^{-1}(\{A'\}) = \langle B \rangle + A \quad
        }
        \uncover<4->{
            \Rightarrow \ \ker(\alpha' \circ \beta) = \beta^{-1}(\ker \alpha') = \langle A, B \rangle & \\
        }
        \uncover<5->{
