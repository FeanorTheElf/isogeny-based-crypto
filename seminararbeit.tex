...
\subsection{Supersingular Isogeny Key Exchange}

In this section, we will comment on the implementation of the SIDH protocol in the SIKE cryptosystem \cite{sike}, which is the (alternative) NIST candidate based on Isogenies.
