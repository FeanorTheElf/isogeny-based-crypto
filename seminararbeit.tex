...
\end{prop}
\begin{proof}
    First, assume $j(E) = j(E')$ and consider the morphism $\phi = [u^2 x, u^3 y, 1]$ where $u^4 = A/A'$.
    Then
    \begin{align*}
    ...
    For the other direction, assume there is an isomorphism $\phi = [\phi_1, \phi_2, \phi_3]$ from $E$ to $E'$, where $\phi_1, \phi_2, \phi_3$ have all degree $d \in \N$.
