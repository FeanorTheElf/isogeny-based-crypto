...
\begin{definition}
    ...
    Namely, $\phi$ is rational if there are homogeneous $f_1, f_2, f_3 \in \bar{K}^+[V]$ of same degree and not all zero such that for each point $(x : y : z)$ at which $\phi$ is defined, there are ``equivalent'' homogeneous polynomials $(g_1, g_2, g_3) \in \bar{K}^+[V], \ (g_1, g_2, g_3) \sim (f_1, f_2, f_3)$ such that
    \begin{equation*}
    ...
    We use the notation $\phi = [f_1, f_2, f_3]$ or $\phi = [f_1^{\mathrm{deh}}, f_2^{\mathrm{deh}}, f_3^{\mathrm{deh}}]$ or $\phi = [f_1^{\mathrm{deh}} / f_3^{\mathrm{deh}}, f_2^{\mathrm{deh}} / f_3^{\mathrm{deh}}, 1]$
...
\begin{definition}
    ...
    We denote its quotient field by $\bar{K}(E)$.
\end{definition}
...
\begin{remark}
    ...
    \begin{align*}
        \left(\frac {f_1'} {g'}, \frac {f_2'} {g'}\right) = \left(\frac {f_1} g, \frac {f_2} g\right) \ &\text{in $K(E)$ and} \\
    ...
    We use the notation $\phi = [f_1, f_2, g]$ or $\phi = [f_1 / g, f_2 / g, 1]$.
\end{remark}
