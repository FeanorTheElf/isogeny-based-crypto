...
\begin{proof}
    ...
    However by \ref{prop:group_operation} the coordinates of a sum of two points are given by a rational function of the summand coordinates, so stay in $L$.
\end{proof}

\section{Isogenies and the Group Structure}
...
\begin{theorem}
    Let $E$ be a supersingular Elliptic Curve over a field of characteristic $p$ such that $j(E) \neq 0, 1728$.
