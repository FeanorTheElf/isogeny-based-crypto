...
\end{prop}
\begin{proof}
    Have $\psi = [\psi_1, \psi_2, \psi_3]$ and consider the ring homomorphism
    \begin{equation*}
        \phi^*: \bar{K}[E'] \to \bar{K}[E], \quad \overline{f} \mapsto \overline{f^{\mathrm{hom}}\left(\psi_1, \psi_2, \psi_3\right)}
    \end{equation*}
    Note that
    \begin{equation*}
